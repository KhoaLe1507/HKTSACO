...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-[#14213d] h-screen flex flex-col py-6 px-4 shadow-lg text-sm fixed top-0 left-0 z-50 overflow-y-auto">
      <div className="mb-8 text-2xl font-bold text-center text-white">Teacher Dashboard</div>
      <nav className="flex-1 space-y-4 text-white">
        ...
        <div>
          <div className="font-semibold mb-1 text-gray-300">📚 Module Sections</div>
          <NavLink to="/professor/sections" className={linkClass}>All Sections</NavLink>
        </div>
