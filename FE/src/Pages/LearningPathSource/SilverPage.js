...
const SilverPage = () => {
  ...
  return (
    <div className="text-black min-h-screen bg-gradient-to-b from-gray-100 to-gray-200">
      ...
      <div className="relative h-64 bg-gradient-to-r from-slate-600 to-slate-800 text-white text-center flex flex-col justify-center items-center overflow-hidden animate-fadeIn">
        <div className="absolute inset-0 z-0 transition-transform duration-1000 ease-out transform scale-100">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1519681393784-d120267933ba?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center opacity-20"></div>
        </div>
      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-8 mb-16">
          {[
            ...
            { title: "Problems Progress", completed: 0, inProgress: 0, skipped: 0, notStarted: 88, total: counts.problemsTotal },
      ...
      <div className="container mx-auto pb-20 px-4">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <div className="absolute left-10 top-0 bottom-0 w-1 bg-gradient-to-b from-slate-400 to-slate-700 rounded"></div>
          ...
          {sections.map((section, i) => (
            ...
            >
              ...
              <div className="flex mb-8">
                <div className="bg-gradient-to-r from-slate-600 to-slate-800 px-8 py-3 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 ml-16">
                ...
                {section.modules.map(([title, desc], j) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute left-0 top-1/2 w-5 h-5 rounded-full bg-white border-4 border-slate-500 shadow-lg transform -translate-x-[40px] -translate-y-1/2 z-10"></div>
                      
                      {/* Module card with hover effect */}
                      <Link
                        to={`/${level}/module/${id}`}
                        className="block bg-white rounded-xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-102 border-l-4 border-slate-500"
                      >
                        <h4 className="text-xl font-bold text-slate-700 mb-2">{title}</h4>
                        <p className="text-gray-600 text-sm">{desc}</p>
                        
                        <div className="mt-3 flex justify-between items-center">
                          <span className="text-xs text-gray-400">Module {i + 1}.{j + 1}</span>
                          <span className="text-slate-600 font-medium text-sm">Start Learning →</span>
                        </div>
                      </Link>
                    </div>
                  );
      ...
      {/* Footer CTA */}
      <div className="bg-gradient-to-r from-slate-700 to-slate-900 text-white py-16 text-center reveal">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-6">Ready to elevate your skills?</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">Begin your Silver journey and master key algorithms and data structures needed for competitive programming.</p>
          <button 
            className="bg-white text-slate-900 px-8 py-3 rounded-full font-bold text-lg shadow-lg hover:bg-slate-100 transition-colors duration-300 hover:scale-105 transform"
          >
            Start First Module
          </button>
        </div>
